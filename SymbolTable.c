...
for(i=0;i<k;++i)
{
    ...
    if(strcmp(s[i],"RETURN")==0)
    {
        ...
        if(array[currentSub][hash(secondval[i])]->totalAssignment==0)
            printf("Return variable not assigned\n");
    }
    ...
    if(strcmp(s[i],"LT")==0 || strcmp(s[i],"LTE")==0|| strcmp(s[i],"GT")==0|| strcmp(s[i],"GTE")==0|| strcmp(s[i],"NEQ")==0|| strcmp(s[i],"EQ")==0|| strcmp(s[i],"AND")==0|| strcmp(s[i],"OR")==0|| strcmp(s[i],"NOT")==0)
    {
        line=string2int(secondval[i]);
        previous=i;
        printf("BoolOP\n");
    ...
    if(strcmp(s[i],"PLUS")==0 || strcmp(s[i],"MINUS")==0|| strcmp(s[i],"MULT")==0|| strcmp(s[i],"DIV")==0)
    {
        line=string2int(secondval[i]);
        previous=i;
        printf("ArithmeticOP\n");
